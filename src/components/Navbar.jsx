...
export default function Navbar() {
  ...
  return (
    <nav className=" px-4 py-2 flex w-full items-center justify-between -mt-16 relative z-50">
      {/* Logo Section */}
      <div className="lg:ml-14 w-16 md:w-48 rounded-full overflow-hidden">
      ...
      <div className="overflow-hidden md:pl-8 bg-[#080253] lg:ml-36 lg:pl-11 lg:pr-4 w-full hidden md:flex items-center justify-between rounded-full mb-8">
        ...
        <Link to="/" className="text-lg py-16 px-1 font-jockey hover:bg-[#0F0775] transition-colors duration-200">
  HOME
</Link>
<Link to="/tokenomics" className="text-lg font-jockey py-16 px-1 hover:bg-[#0F0775] transition-colors duration-200">
  TOKENOMICS
</Link>
          <ScrollLink
            to="about-us"
            smooth={true}
            duration={500}
            className="text-lg font-jockey py-16 px-1 hover:bg-[#0F0775] transition-colors duration-200 cursor-pointer whitespace-nowrap"
          >
            ABOUT US
          </ScrollLink>
          <ScrollLink
            ...
            smooth={true}
            duration={500}
            className="text-lg font-jockey py-16 px-1 hover:bg-[#0F0775] transition-colors duration-200 cursor-pointer"
          >
            MERCH
          </ScrollLink>
          <ScrollLink
